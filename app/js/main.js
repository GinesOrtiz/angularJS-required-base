(function () {
    ...
    require.config({
        paths: {
            ...
            bootstrap: '../bower_components_min/bootstrap/js/bootstrap',
            utils: 'utils/utils'
        },
        shim: {
            'angular': {
    ...
    require([
        ...
        function (angular, angularAnimate, angularSanitize, angularRoute, angularResource, angularWebStorage, jquery, config, app, filters, translation, modules, bootstrap, utils) {
